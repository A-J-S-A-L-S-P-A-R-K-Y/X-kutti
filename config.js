...
module.exports = {
  mongodb: process.env.MONGODB_URL || "mongodb+srv://Krizvedi:VevQYIr1aR6zuSUs@cluster0.kglzhgp.mongodb.net/?retryWrites=true&w=majority",
  ...
  SESSION_ID: process.env.SESSION_ID || "X-BOT-MD:LedgeForesee",
